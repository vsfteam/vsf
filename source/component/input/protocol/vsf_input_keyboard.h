...
// get scancode if pressed, returns length of scancode

#define vsf_input_keyboard_get_scancode_from_keycode(__keycode, __scancode_ptr) \
...
enum {
    VSF_KM_NONE             = 0x00,
    VSF_KM_LEFT_CTRL        = 0x01,
    VSF_KM_LCTRL            = 0x01,
    VSF_KM_LEFT_SHIFT       = 0x02,
    VSF_KM_LSHIFT           = 0x02,
    VSF_KM_LEFT_ALT         = 0x04,
    VSF_KM_LALT             = 0x04,
    VSF_KM_LEFT_GUI         = 0x08,
    VSF_KM_LGUI             = 0x08,
    VSF_KM_RIGHT_CTRL       = 0x10,
    VSF_KM_RCTRL            = 0x10,
    VSF_KM_RIGHT_SHIFT      = 0x20,
    VSF_KM_RSHIFT           = 0x20,
...
extern uint_fast8_t __vsf_input_keyboard_get_scancode(uint8_t keycode, uint8_t scancode[6]);
