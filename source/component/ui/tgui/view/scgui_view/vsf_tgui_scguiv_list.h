...
#ifndef __VSF_TINY_GUI_SCGUIV_LIST_H__
#define __VSF_TINY_GUI_SCGUIV_LIST_H__
...
#define vsf_tgui_list_v_render              vsf_tgui_container_v_render
#define vsf_tgui_list_v_post_render         vsf_tgui_container_v_post_render
