...
{
    SC_pfb_DrawFill(dest, xs, ys, xe, ys+width-1,fc);  //上
    SC_pfb_DrawFill(dest, xs, ye-width+1, xe, ye,fc);  //下
    SC_pfb_DrawFill(dest, xs, ys+width, xs+width-1, ye-width,fc);  //左
    SC_pfb_DrawFill(dest, xe-width+1, ys+width, xe, ye-width,fc);  //右
}
