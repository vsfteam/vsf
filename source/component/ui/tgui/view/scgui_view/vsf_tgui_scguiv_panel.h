...
#ifndef __VSF_TINY_GUI_SCGUIV_PANEL_H__
#define __VSF_TINY_GUI_SCGUIV_PANEL_H__
...
extern fsm_rt_t vsf_tgui_panel_v_depose(vsf_tgui_t *gui_ptr, vsf_tgui_panel_t* ptPanel);
