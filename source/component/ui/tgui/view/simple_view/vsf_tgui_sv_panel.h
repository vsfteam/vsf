...
#ifndef __VSF_TINY_GUI_V_PANEL_H__
...
extern fsm_rt_t vsf_tgui_panel_v_depose(vsf_tgui_panel_t* panel_ptr);

extern fsm_rt_t vsf_tgui_panel_v_update(vsf_tgui_panel_t* panel_ptr);
