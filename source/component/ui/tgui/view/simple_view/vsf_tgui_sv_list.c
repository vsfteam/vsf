                                    ...
                                    vsf_tgui_control_refresh_mode_t mode)
{
    ...
    vsf_tgui_container_v_render(gui_ptr, &(list_ptr->use_as__vsf_tgui_container_t), dirty_region_ptr, mode);
...
fsm_rt_t vsf_tgui_list_v_post_render(   vsf_tgui_t *gui_ptr,
                                        ...
                                        vsf_tgui_control_refresh_mode_t mode)
{
    return vsf_tgui_container_v_post_render(gui_ptr, (vsf_tgui_container_t *)list_ptr, dirty_region_ptr, mode);
}
