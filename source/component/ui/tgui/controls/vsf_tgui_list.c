...
static const i_tgui_control_methods_t c_tVList = {
    ...
    .Update =   (vsf_tgui_control_method_t *)&vk_tgui_list_update,
    ...
    switch (ptInnerContainer->ContainerAttribute.u5Type) {
        case VSF_TGUI_CONTAINER_TYPE_LINE_STREAM_VERTICAL:
            ...
            do {
                ...
                tRectRegionsY.tBar.tLocation.iY +=iScrollbarTrackPieceSize*(-ptListInnerContainerLocation->iY)/iInnerContainerRawSize;    // ������Ϊ��ֵʱ����������
                ...
                if ((tRectRegionsY.tBar.tLocation.iY)<(tRectRegionsY.tTrack.tLocation.iY)) {
                     tRectRegionsY.tBar.tSize.iHeight-=(tRectRegionsY.tTrack.tLocation.iY-tRectRegionsY.tBar.tLocation.iY);//�ض�
        ...
        case VSF_TGUI_CONTAINER_TYPE_LINE_STREAM_HORIZONTAL:
            ...
            iScrollbarSize = iListRawSize/chScalingRatio;
            iScrollbarTrackPieceSize = iInnerContainerRawSize/chScalingRatio;
            iOriginOffset = (ptPanelSize->iWidth / 2) - (iScrollbarTrackPieceSize/2); // ����
            ...
            do {
                ...
                if ((tRectRegionsX.tBar.tLocation.iX)<(tRectRegionsX.tTrack.tLocation.iX)) {
                     tRectRegionsX.tBar.tSize.iWidth-=(tRectRegionsX.tTrack.tLocation.iX-tRectRegionsX.tBar.tLocation.iX);//�ض�
