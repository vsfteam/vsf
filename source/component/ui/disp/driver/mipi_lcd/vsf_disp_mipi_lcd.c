...
#       define MIPI_LCD_SPI_CFG                         (SPI_MASTER | SPI_MODE_3 | SPI_MSB_FIRST | SPI_DATASIZE_8)
#   elif VSF_DISP_MIPI_LCD_SPI_MODE == VSF_DISP_MIPI_LCD_SPI_8BITS_MODE
#       define MIPI_LCD_SPI_CFG                         (SPI_MASTER | SPI_MODE_3 | SPI_MSB_FIRST | SPI_DATASIZE_9)
#   endif
#endif
