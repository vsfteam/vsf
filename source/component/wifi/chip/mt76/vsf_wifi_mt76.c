...
static uint8_t __mt76_eeprom_get_u8(mt76_wifi_priv_t *priv, uint16_t offset)
{
    return priv->eeprom[offset];
}

/* Forward declarations needed by TX power helpers. */
...
static vsf_err_t __mt76_apply_tx_power(vsf_wifi_t *wifi, uint8_t channel,
