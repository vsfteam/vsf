...
extern void vsf_lvgl_bind_disp(vk_disp_t *disp, lv_disp_drv_t *lvgl_disp_drv);
extern void vsf_lvgl_flush_disp(lv_disp_drv_t *disp_drv, const lv_area_t *area, lv_color_t *color_p);
