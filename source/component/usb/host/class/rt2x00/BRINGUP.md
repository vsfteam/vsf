...
+-----------------------------------+   USB 传输层  usb/host/class/rt2x00/
| vsf_usbh_wifi_rt2x00.c / .h / _priv.h    |   - vk_usbh_class_drv probe (VID/PID)
...
| `usb/host/class/rt2x00/vsf_usbh_wifi_rt2x00.h / .c` | USB 传输层：probe + bulk RX/TX + ep0 后端 |
| `usb/host/class/rt2x00/vsf_usbh_wifi_rt2x00_priv.h` | USB 层内部结构 |
| `usb/host/class/rt2x00/BRINGUP.md` | 本文 |
