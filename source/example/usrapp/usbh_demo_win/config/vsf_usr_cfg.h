...
#   define VSF_LIBUSB_HCD_CFG_DEV_NUM                   7
#   define VSF_LIBUSB_HCD_DEV0_VID                      0x0A12      // CSR8510 bthci
#   define VSF_LIBUSB_HCD_DEV0_PID                      0x0001
#   define VSF_LIBUSB_HCD_DEV1_VID                      0x0A5C      // BCM20702A0 bthci
#   define VSF_LIBUSB_HCD_DEV1_PID                      0x21E8
#   define VSF_LIBUSB_HCD_DEV2_VID                      0x054C      // DS4
#   define VSF_LIBUSB_HCD_DEV2_PID                      0x05C4
#   define VSF_LIBUSB_HCD_DEV3_VID                      0x054C      // DS4
#   define VSF_LIBUSB_HCD_DEV3_PID                      0x09CC
#   define VSF_LIBUSB_HCD_DEV4_VID                      0x057E      // NSPRO
#   define VSF_LIBUSB_HCD_DEV4_PID                      0x2009
#   define VSF_LIBUSB_HCD_DEV5_VID                      0x045E      // XB360
#   define VSF_LIBUSB_HCD_DEV5_PID                      0x028E
#   define VSF_LIBUSB_HCD_DEV6_VID                      0x045E      // XB1
#   define VSF_LIBUSB_HCD_DEV6_PID                      0x02EA
