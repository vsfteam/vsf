...
#define LV_OBJ_FREE_PTR         0           /*Enable the free pointer attribute*/
...
#if USE_LV_LABEL != 0
#  define LV_LABEL_SCROLL_SPEED       30     /*Hor, or ver. scroll speed [px/sec] in 'LV_LABEL_LONG_SCROLL/ROLL' mode*/
#endif
...
#include "component/3rd-party/littlevgl/5.3/raw/lvgl/lv_conf_checker.h"
