...
#       define VSF_TGUI_SV_BUTTON_ADDITIONAL_TILES      ENABLED
#       define VSF_TGUI_SV_BUTTON_BACKGROUND_COLOR      VSF_TGUI_COLOR_DEF(0xB4, 0xC7, 0xE7)
#       define VSF_TGUI_SV_PANEL_ADDITIONAL_TILES       ENABLED
#       define VSF_TGUI_SV_PANEL_BACKGROUND_COLOR       VSF_TGUI_COLOR_DEF(0x44, 0x72, 0xC4)
