...
#ifndef __MACOS_GENERIC_H__
#define __MACOS_GENERIC_H__
...
#if     defined(__VSF_ARCH_MACOS_IMPLEMENT)
...
#   error VSF_ARCH_PRI_NUM MUST be 1 for macos
#endif
...
#   error VSF_ARCH_SWI_NUM MUST be 0 for macos
#endif
