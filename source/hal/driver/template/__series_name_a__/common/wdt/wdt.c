 ...
 *      For peripherial drivers, if IPCore driver is used, define __VSF_HAL_${WDT_IP}_WDT_CLASS_INHERIT__ before including vsf_hal.h
 */
 ...
 *      For other drivers, plase define VSF_${WDT_IP}_WDT_CFG_MULTI_CLASS in header file.
 */
