 ...
 *      For peripherial drivers, if IPCore driver is used, define __VSF_HAL_${DAC_IP}_DAC_CLASS_INHERIT__ before including vsf_hal.h
 */
 ...
 *      For other drivers, plase define VSF_${DAC_IP}_DAC_CFG_MULTI_CLASS in header file.
 */
