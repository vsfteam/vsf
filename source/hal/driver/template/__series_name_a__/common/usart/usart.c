 ...
 *      For peripherial drivers, if IPCore driver is used, define __VSF_HAL_${USART_IP}_USART_CLASS_INHERIT__ before including vsf_hal.h
 */
 ...
 *      For other drivers, plase define VSF_${USART_IP}_USART_CFG_MULTI_CLASS in header file.
 */
