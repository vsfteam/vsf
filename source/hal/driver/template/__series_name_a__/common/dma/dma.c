 ...
 *      For peripherial drivers, if IPCore driver is used, define __VSF_HAL_${DMA_IP}_DMA_CLASS_INHERIT__ before including vsf_hal.h
 */
 ...
 *      For other drivers, plase define VSF_${DMA_IP}_DMA_CFG_MULTI_CLASS in header file.
 */
