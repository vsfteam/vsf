 ...
 *      For peripherial drivers, if IPCore driver is used, define __VSF_HAL_${SPI_IP}_SPI_CLASS_INHERIT__ before including vsf_hal.h
 */
 ...
 *      For other drivers, plase define VSF_${SPI_IP}_SPI_CFG_MULTI_CLASS in header file.
 */
