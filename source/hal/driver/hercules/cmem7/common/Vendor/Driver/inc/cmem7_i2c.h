...
/** @defgroup I2C_STATUS
  * @{
  */
#define I2C_Flag_RX_FIFO_NOT_EMPTY     0x00200000 		/*!< Can't be clear but read FIFO */
#define I2C_Flag_RD_REQUEST            0x01000000     /*!< Slave was requested to send data */
#define I2C_Flag_TX_ABORT              0x02000000     /*!< Error while sending data */
#define I2C_Flag_RX_DONE               0x04000000     /*!< Slave sent all requested data */
#define I2C_Flag_TX_DONE               0x08000000     /*!< Master accomplish to send all data */

#define I2C_Flag_ALL                   (I2C_Flag_RX_FIFO_NOT_EMPTY | \
																				I2C_Flag_RD_REQUEST | \
																				I2C_Flag_TX_ABORT | \
																				I2C_Flag_RX_DONE | \
																				I2C_Flag_TX_DONE)

#define IS_I2C_FLAG(FLAG)              (((FLAG) != 0) && (((FLAG) & ~I2C_Flag_ALL) == 0))
/**
  * @}
  */
...
/**
  ...
  * @param[in] init A pointer to structure I2C_InitTypeDef which will be initialized.
  * @retval None
  */ 
...
/**
  * @brief  Check specific status are set or not 
	* @param[in] I2Cx I2C peripheral, which is I2C0 or I2C1
	* @param[in] Flag Status mask bits, which can be the combination of @ref I2C_Flag
...
/**
  * @brief  I2C send read request in master mode
	...
	* @param[in] I2Cx I2C peripheral, which is I2C0 or I2C1
    * @param[in] Addr  7- or 10-bits address
