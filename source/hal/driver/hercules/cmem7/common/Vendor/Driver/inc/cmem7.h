...
typedef struct {                                    /*!< GLOBAL_CTRL Structure                                                 */
  ...
  union {
    __IO uint32_t  NMI_SEL;                         /*!< nmi interrupt selection h4100_741c                                    */
  ...
  union {
    __IO uint32_t  ICACHE;                          /*!< ICACHE Enable h4100_7438                                              */
    
    struct {
      __IO uint32_t  EN         :  1;               /*!< ICACHE Enable                                                         */
    } ICACHE_b;                                     /*!< BitSize                                                               */
  };
  __IO uint32_t  IBUSOFF;                           /*!< Code Bus Offset h4100_743C                                            */
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  LANE       :  1;               /*!< LANE synchronization logic bypass                                     */
           uint32_t             :  3;
      __IO uint32_t  adec_sel   :  1;               /*!< address decoder mapping                                               */
      __IO uint32_t  perfm_sel  :  1;      
					 uint32_t             :  2;
