...
/**
  * @brief  Deinitializes the EFUSE peripheral registers to their default reset values.
	* @param[in] None
  * @retval None
	*/ 
...
void EFUSE_Init(EFUSE_InitTypeDef* init);
 ...
 /**
  * @brief  Fills each EFUSE_InitTypeDef member with its default value.
	* @param[in] init A pointer to structure UART_InitTypeDef which will be initialized.
  * @retval None
	*/ 
