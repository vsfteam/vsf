...
#define ADC1_INT_OVERFLOW                 0x2
#define ADC2_INT_ALMOST_FULL              0x8
#define ADC2_INT_OVERFLOW                 0x10
#define ADC_INT_ALL              					0x1B
...
/** @defgroup ADC_FLAG
  * @{
  */																					 
#define ADC1_FLAG_EMPTY                   0x1 
#define ADC2_FLAG_EMPTY                   0x2
#define ADC1_FLAG_FULL                    0x10
#define ADC2_FLAG_FULL                    0x20
#define ADC1_FLAG_ALMOST_FULL             0x40
#define ADC2_FLAG_ALMOST_FULL             0x80
#define ADC_FLAG_ALL              				0xF3

#define IS_ADC_FLAG(FLAG)        					(((FLAG) != 0) && (((FLAG) & ~ADC_FLAG_ALL) == 0))
/**
  * @}
  */
...
void ADC_Init(ADC_InitTypeDef* init);
  ...
  * @brief  Fills each ADC_InitTypeDef member with its default value.
	* @param[in] init A pointer to structure ADC_InitTypeDef which will be initialized.
  * @retval None
	*/ 
...
/**
  * @brief  Check specific flags are set or not 
	* @param[in] Flag which can be the combination of @ref ADC_Flag
