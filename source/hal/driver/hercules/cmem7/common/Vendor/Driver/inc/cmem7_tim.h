...
/**
  ...
  * @retval None
	*/ 
void TIM_ITConfig(TIMER0_Type* Timx, BOOL Enable);
...
/**
  * @brief  Check the specific interrupt is set or not 
	...
	*/
BOOL TIM_GetITStatus(TIMER0_Type* Timx);
...
/**
  * @brief  Clear specific interrupts
	...
	* @retval None
	*/
void TIM_ClearITPendingBit(TIMER0_Type* Timx);
...
/**
  ...
  * @retval None
	*/ 
void TIM_Cmd(TIMER0_Type* Timx, BOOL Enable);
