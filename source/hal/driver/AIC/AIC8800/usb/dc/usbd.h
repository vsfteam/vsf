...
#ifndef __OSA_HAL_DRIVER_AIC_AIC8800_USBD_H__
#define __OSA_HAL_DRIVER_AIC_AIC8800_USBD_H__
...
extern vsf_err_t aic8800_usbd_init(aic8800_usb_t *dc, usb_dc_ip_cfg_t *cfg);
extern void aic8800_usbd_fini(aic8800_usb_t *dc);
