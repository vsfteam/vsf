...
#ifndef VSF_HAL_TEMPLATE_REMAP_TYPE
#   define VSF_HAL_TEMPLATE_REMAP_TYPE                      VSF_MCONNECT(VSF_HAL_TEMPLATE_DEC_REMAP_PREFIX, VSF_HAL_TEMPLATE_DEC_NAME, _t)
#endif
...
#ifndef VSF_HAL_TEMPLATE_DEC_INSTANCE_INLINE_API
#   define VSF_HAL_TEMPLATE_DEC_INSTANCE_INLINE_API         VSF_MCONNECT(VSF, VSF_HAL_TEMPLATE_DEC_UPCASE_NAME, _INLINE_APIS)
#endif
...
typedef struct VSF_HAL_TEMPLATE_REMAP_TYPE VSF_HAL_TEMPLATE_DEC_TYPE;
...
#ifdef VSF_HAL_TEMPLATE_DEC_INLINE_API
VSF_HAL_TEMPLATE_DEC_INSTANCE_INLINE_API(VSF_HAL_TEMPLATE_DEC_PREFIX)
#endif
...
#undef VSF_HAL_TEMPLATE_DEC_INLINE_API
