...
#ifndef VSF_HAL_CFG_IMP_COUNT_MASK_PREFIX
#   define VSF_HAL_CFG_IMP_COUNT_MASK_PREFIX                VSF_MCONNECT(VSF, VSF_HAL_TEMPLATE_IMP_UPCASE_NAME, _CFG_IMP_COUNT_MASK_PREFIX)
#endif

#ifndef VSF_HAL_CFG_IMP_WRAP_PREFIX
#   define VSF_HAL_CFG_IMP_WRAP_PREFIX                      VSF_MCONNECT(VSF, VSF_HAL_TEMPLATE_IMP_UPCASE_NAME, _CFG_IMP_WRAP_PREFIX)
#endif
...
#   define VSF_HAL_TEMPLATE_IMP_DEFINED_COUNT               VSF_MCONNECT(VSF_HAL_CFG_IMP_COUNT_MASK_PREFIX, VSF_HAL_TEMPLATE_IMP_UPCASE_NAME, VSF_HAL_TEMPLATE_IMP_COUNT_SUFFIX)
#endif

#ifndef VSF_HAL_TEMPLATE_IMP_DEFINED_MASK
#   define VSF_HAL_TEMPLATE_IMP_DEFINED_MASK                VSF_MCONNECT(VSF_HAL_CFG_IMP_COUNT_MASK_PREFIX, VSF_HAL_TEMPLATE_IMP_UPCASE_NAME, VSF_HAL_TEMPLATE_IMP_MASK_SUFFIX)
#endif
...
#   define VSF_HAL_TEMPLATE_IMP_INSTANCE_ARRAY              VSF_MCONNECT(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_TEMPLATE_IMP_NAME, s)
#endif

#define VSF_HAL_TEMPLATE_IMP_INSTANCE_ARRAY_ITEM(__INDEX, __NULL)                      \
                                                            &VSF_MCONNECT(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_TEMPLATE_IMP_NAME, __INDEX),

#ifndef VSF_HAL_TEMPLATE_IMP_INSTANCE_INDEX_ARRAY
#   define VSF_HAL_TEMPLATE_IMP_INSTANCE_INDEX_ARRAY        VSF_MCONNECT(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_TEMPLATE_IMP_NAME, _indexs)
#endif

#ifndef VSF_HAL_TEMPLATE_IMP_INSTANCE_NAME_ARRAY
#   define VSF_HAL_TEMPLATE_IMP_INSTANCE_NAME_ARRAY         VSF_MCONNECT(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_TEMPLATE_IMP_NAME, _names)
#endif

#ifndef VSF_HAL_TEMPLATE_IMP_DEVICE_ARRAY
#   define VSF_HAL_TEMPLATE_IMP_DEVICE_ARRAY                VSF_MCONNECT(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_TEMPLATE_IMP_NAME, _devices)
#endif

#ifdef VSF_HAL_TEMPLATE_IMP_WRAP_PREFIX
VSF_MCONNECT(VSF, VSF_HAL_TEMPLATE_IMP_UPCASE_NAME, _API_WRAP)(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_CFG_IMP_WRAP_PREFIX)
#endif
...
#       define __VSF_HAL_TEMPLATE_ARG                              VSF_MCONNECT(VSF_HAL_TEMPLATE_IMP_PREFIX, VSF_HAL_TEMPLATE_IMP_NAME)
#       include "./vsf_template_instance_mask.h"
};
...
#undef VSF_HAL_TEMPLATE_IMP_WRAP_PREFIX
