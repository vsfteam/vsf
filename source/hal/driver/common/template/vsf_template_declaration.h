...
#define __VSF_HAL_TEMPLATE_PREFIX                VSF_MCONNECT(VSF_, __VSF_HAL_TEMPLATE_UPCASE_NAME, _CFG_API_DECLARATION_PREFIX)
...
typedef struct VSF_MCONNECT(__VSF_HAL_TEMPLATE_PREFIX, _, __VSF_HAL_TEMPLATE_NAME, _t)         \
    VSF_MCONNECT(__VSF_HAL_TEMPLATE_PREFIX, _, __VSF_HAL_TEMPLATE_NAME, _t);
...
#       define __VSF_HAL_TEMPLATE_DEC_MASK   VSF_MCONNECT(__VSF_HAL_TEMPLATE_UPCASE_PREFIX, _, __VSF_HAL_TEMPLATE_UPCASE_NAME, _MASK)
#   else
...
#   define __VSF_HAL_TEMPLATE_DEC_LV0(__COUNT, __DONT_CARE)                                 \
        extern VSF_MCONNECT(__VSF_HAL_TEMPLATE_PREFIX, _, __VSF_HAL_TEMPLATE_NAME, _t)      \
            VSF_MCONNECT(__VSF_HAL_TEMPLATE_PREFIX, _, __VSF_HAL_TEMPLATE_NAME, __COUNT);
