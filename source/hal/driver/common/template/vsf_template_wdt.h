...
/**
 ...
 @param[in] wdt_ptr: a pointer to structure @ref vsf_wdt_t
 @return fsm_rt_t: return FSM_RT_CPL if wdt was enabled, return FSM_RT_ONGOING if wdt is enabling

 \~chinese
 @brief 使能一个 wdt 实例
 @param[in] wdt_ptr: 结构体 vsf_wdt_t 的指针，参考 @ref vsf_wdt_t
 @return fsm_rt_t: 返回 FSM_RT_CPL 如果 wdt 实例被使能，返回 FSM_RT_ONGOING 如果 wdt 实例正在使能
 */
...
/**
 ...
 @param[in] wdt_ptr: a pointer to structure @ref vsf_wdt_t
 @return fsm_rt_t: return FSM_RT_CPL if wdt was disabled, return FSM_RT_ONGOING if wdt is disabling

 \~chinese
 @brief 禁能一个 wdt 实例
 @param[in] wdt_ptr: 结构体 vsf_wdt_t 的指针，参考 @ref vsf_wdt_t
 @return fsm_rt_t: 返回 FSM_RT_CPL 如果 wdt 实例被禁能，返回 FSM_RT_ONGOING 如果 wdt 实例正在禁能
 */
