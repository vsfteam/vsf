...
#define __VSF_HAL_TEMPLATE_PREFIX                VSF_MCONNECT(VSF_, __VSF_HAL_TEMPLATE_UPCASE_NAME, _CFG_PREFIX)
#define __VSF_HAL_TEMPLATE_UPCASE_PREFIX         VSF_MCONNECT(VSF_, __VSF_HAL_TEMPLATE_UPCASE_NAME, _CFG_UPPERCASE_PREFIX)

// #if VSF_ADC_CFG_IMPLEMENT_OP == ENABLED
#if VSF_MCONNECT(VSF_, __VSF_HAL_TEMPLATE_UPCASE_NAME, _CFG_IMPLEMENT_OP) == ENABLED
#   define __VSF_HAL_OP_VAR     VSF_MCONNECT(__, __VSF_HAL_TEMPLATE_PREFIX, _, __VSF_HAL_TEMPLATE_NAME, _op)
#   define __VSF_HAL_OP         .VSF_MCONNECT(vsf_, __VSF_HAL_TEMPLATE_NAME).op = & __VSF_HAL_OP_VAR,

#   undef __VSF_HAL_TEMPLATE_API
#   define __VSF_HAL_TEMPLATE_API VSF_HAL_TEMPLATE_API_OP

static const VSF_MCONNECT(vsf_, __VSF_HAL_TEMPLATE_NAME, _op_t) __VSF_HAL_OP_VAR = {
    VSF_MCONNECT(VSF_, __VSF_HAL_TEMPLATE_UPCASE_NAME, _APIS) (__VSF_HAL_TEMPLATE_PREFIX)
};
...
#if VSF_MCONNECT(__VSF_HAL_TEMPLATE_UPCASE_PREFIX, _, __VSF_HAL_TEMPLATE_UPCASE_NAME, _COUNT)
#    define __VSF_HAL_TEMPLATE_DEC_COUNT  VSF_MCONNECT(__VSF_HAL_TEMPLATE_UPCASE_PREFIX, _, __VSF_HAL_TEMPLATE_UPCASE_NAME, _COUNT)
#endif

#if VSF_MCONNECT(__VSF_HAL_TEMPLATE_UPCASE_PREFIX, _, __VSF_HAL_TEMPLATE_UPCASE_NAME, _MASK)
// expand to:
//  #define __VSF_HAL_TEMPLATE_DEC_COUNT     VSF_HW_ADC_MASK
#   define __VSF_HAL_TEMPLATE_IMP_MASK   VSF_MCONNECT(__VSF_HAL_TEMPLATE_UPCASE_PREFIX, _, __VSF_HAL_TEMPLATE_UPCASE_NAME, _MASK)
#else
#   define __VSF_HAL_TEMPLATE_IMP_MASK   ((1ul << __VSF_HAL_TEMPLATE_DEC_COUNT) - 1)
#endif

#   define __VSF_HAL_TEMPLATE_IMP_LV0   VSF_MCONNECT(VSF_, __VSF_HAL_TEMPLATE_UPCASE_NAME, _CFG_IMP_LV0)
