...
#   define VSF_PWM_CFG_DEC_INSTANCE_PREFIX          VSF_PWM_CFG_DEC_PREFIX
#endif
...
#   define VSF_HAL_TEMPLATE_DEC_UPCASE_PREFIX       VSF_PWM_CFG_DEC_UPCASE_PREFIX
#endif
...
#undef VSF_PWM_CFG_DEC_INSTANCE_PREFIX
