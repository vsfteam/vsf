                                   ...
                                   vsf_gpio_exti_irq_cfg_t *irq_cfg_ptr)
{
    ...
    return vsf_gpio_irq_distributor_pin_config(&exti_gpio_ptr->distributor, pin_mask, irq_cfg_ptr);
}
...
vsf_gpio_capability_t vsf_exti_gpio_capability(vsf_exti_gpio_t *exti_gpio_ptr)
{
    ...
    return vsf_gpio_capability(exti_gpio_ptr->distributor.gpio);
}
                                         ...
                                         vsf_gpio_cfg_t *cfg_ptr)
{
    ...
    return vsf_gpio_port_config_pins(exti_gpio_ptr->distributor.gpio, pin_mask, cfg_ptr);
}
                                              ...
                                              vsf_gpio_cfg_t *cfg_ptr)
{
    ...
    return vsf_gpio_get_pin_configuration(exti_gpio_ptr->distributor.gpio, pin_index, cfg_ptr);
}
                                ...
                                vsf_gpio_pin_mask_t direction_mask)
{
    ...
    vsf_gpio_set_direction(exti_gpio_ptr->distributor.gpio, pin_mask, direction_mask);
}
                                               ...
                                               vsf_gpio_pin_mask_t pin_mask)
{
    ...
    return vsf_gpio_get_direction(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                            ...
                            vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_set_input(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                             ...
                             vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_set_output(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                                   ...
                                   vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_switch_direction(exti_gpio_ptr->distributor.gpio, pin_mask);
}
...
vsf_gpio_pin_mask_t vsf_exti_gpio_read(vsf_exti_gpio_t *exti_gpio_ptr)
{
    ...
    return vsf_gpio_read(exti_gpio_ptr->distributor.gpio);
}
...
vsf_gpio_pin_mask_t vsf_exti_gpio_read_output_register(vsf_exti_gpio_t *exti_gpio_ptr)
{
    ...
    return vsf_gpio_read_output_register(exti_gpio_ptr->distributor.gpio);
}
                        ...
                        vsf_gpio_pin_mask_t value)
{
    ...
    vsf_gpio_write(exti_gpio_ptr->distributor.gpio, pin_mask, value);
}
                      ...
                      vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_set(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                        ...
                        vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_clear(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                         ...
                         vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_toggle(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                                 ...
                                 vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_output_and_set(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                                   ...
                                   vsf_gpio_pin_mask_t pin_mask)
{
    ...
    vsf_gpio_output_and_clear(exti_gpio_ptr->distributor.gpio, pin_mask);
}
                                        ...
                                        vsf_gpio_exti_irq_cfg_t *irq_cfg_ptr)
{
    ...
    return vsf_gpio_exti_irq_config(exti_gpio_ptr->distributor.gpio, irq_cfg_ptr);
}
                                        ...
                                        vsf_gpio_pin_mask_t pin_mask)
{
    ...
    return vsf_gpio_exti_irq_enable(exti_gpio_ptr->distributor.gpio, pin_mask);
}
