...
#ifndef VSF_HOSTOS_RTC_CFG_MULTI_CLASS
#   define VSF_HOSTOS_RTC_CFG_MULTI_CLASS       VSF_RTC_CFG_MULTI_CLASS
#endif

/*============================ TYPES =========================================*/

typedef struct vsf_hostos_rtc_t {
#if VSF_HOSTOS_RTC_CFG_MULTI_CLASS == ENABLED
    vsf_rtc_t vsf_rtc;
#endif
...
#define VSF_RTC_CFG_IMP_LV0(__IDX, __HAL_OP)                                    \
    vsf_hostos_rtc_t vsf_hostos_rtc ## __IDX  = {                               \
        __HAL_OP                                                                \
    };
