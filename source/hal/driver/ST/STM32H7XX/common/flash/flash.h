...
typedef enum vsf_flash_irq_mask_t {
    // 16: EOPIE(16) IN FLASH_CR
    VSF_FLASH_IRQ_ERASE_MASK            = (1 << 16),
    // 15: EOPIE(16) IN FLASH_CR, shift right by 1 to avoid conflict with VSF_FLASH_IRQ_ERASE_MASK
    VSF_FLASH_IRQ_WRITE_MASK            = (1 << 16) >> 1,
    // 14
    VSF_FLASH_IRQ_READ_MASK             = (1 << 14),

    // 22: OPERRIE(22) IN FLASH_CR
    VSF_FLASH_IRQ_ERASE_ERROR_MASK      = (1 << 22),
    // 17..19, 21, 22: WRPERRIE(17), PGSERRIE(18), STRBERRIE(19), INCERRIE(21), OPERRIE(22) IN FLASH_CR
    VSF_FLASH_IRQ_WRITE_ERROR_MASK      = (1 << 17) | (1 << 18) | (1 << 19) | (1 << 21) | (1 << 22),
    // 23..24: RDPERRIE(23), RDSERRIE(24) IN FLASH_CR
