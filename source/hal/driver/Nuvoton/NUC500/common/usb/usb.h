...
#ifndef __HAL_DRIVER_NUVOTON_NUC500_USB_H__
#define __HAL_DRIVER_NUVOTON_NUC500_USB_H__
...
#define __USB_HC_DEF(__N, __TYPE)                                               \
    extern nuc500_##__TYPE##_t USB_HC##__N##_IP;                                \
...
#define __USB_DC_DEF(__N, __TYPE)                                               \
    extern nuc500_##__TYPE##_t USB_DC##__N;                                     \
...
VSF_MREPEAT(USB_HC_COUNT, USB_HC_DEF, NULL)
VSF_MREPEAT(USB_DC_COUNT, USB_DC_DEF, NULL)
