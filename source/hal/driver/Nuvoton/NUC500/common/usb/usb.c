...
VSF_MREPEAT(USB_HC_COUNT, __USB_HC_IP_BODY, nuc500_ohci)
#endif

#if USB_DC_HS_COUNT > 0
VSF_MREPEAT(USB_DC_HS_COUNT, __USB_DC_BODY, nuc500_usbd_hs)
#endif

#if USB_DC_FS_COUNT > 0
VSF_MREPEAT(USB_DC_FS_COUNT, __USB_DC_BODY, nuc500_usbd_fs)
#endif
