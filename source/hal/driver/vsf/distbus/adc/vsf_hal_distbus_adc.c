...
static bool __vsf_hal_distbus_adc_msghandler(vsf_distbus_t *bus, vsf_distbus_service_t *service, vsf_distbus_msg_t *msg);
...
{
    vsf_hal_distbus_adc_t *adc = container_of(service, vsf_hal_distbus_adc_t, service);
