...
#define __VSF_HAL_DISTBUS_SPI_CLASS_IMPLEMENT
#include "../driver.h"
...
static bool __vsf_hal_distbus_spi_msghandler(vsf_distbus_t *bus, vsf_distbus_service_t *service, vsf_distbus_msg_t *msg);

/*============================ GLOBAL VARIABLES ==============================*/
/*============================ LOCAL VARIABLES ===============================*/

static const vsf_distbus_service_info_t __vsf_hal_distbus_spi_info = {
    .mtu                = VSF_HAL_DISTBUS_CFG_MTU,
    .type               = 0,
    .addr_range         = VSF_HAL_DISTBUS_SPI_CMD_ADDR_RANGE,
    .handler            = __vsf_hal_distbus_spi_msghandler,
};
...
{
    vsf_hal_distbus_spi_t *spi = container_of(service, vsf_hal_distbus_spi_t, service);
