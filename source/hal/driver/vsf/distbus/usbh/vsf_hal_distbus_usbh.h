...
#ifndef VSF_HAL_DISTBUS_USBH_CFG_MULTI_CLASS
#   define VSF_HAL_DISTBUS_USBH_CFG_MULTI_CLASS     VSF_USBH_CFG_MULTI_CLASS
#endif
...
#if VSF_HAL_DISTBUS_USBH_CFG_MULTI_CLASS == ENABLED
    public_member(
        implement(vsf_usbh_t)
    )
#endif
    protected_member(
