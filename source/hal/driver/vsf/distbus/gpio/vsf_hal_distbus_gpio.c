...
vsf_err_t vsf_hal_distbus_gpio_config_exti_interrupt(vsf_hal_distbus_gpio_t *gpio, vsf_gpio_pin_mask_t pin_mask, vsf_arch_prio_t prio)
{
    return VSF_ERR_NOT_SUPPORT;
}

vsf_err_t vsf_hal_distbus_gpio_config_exti(vsf_hal_distbus_gpio_t *gpio, vsf_gpio_pin_irq_cfg_t *cfg)
{
    return VSF_ERR_NOT_SUPPORT;
}
