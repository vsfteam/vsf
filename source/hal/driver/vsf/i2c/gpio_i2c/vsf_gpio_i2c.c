...
vsf_err_t vsf_gpio_i2c_init(vsf_gpio_i2c_t *gpio_i2c_ptr, vsf_i2c_cfg_t *cfg_ptr)
{
    ...
    vsf_gpio_config_pin(gpio_i2c_ptr->port, 1 << gpio_i2c_ptr->scl_pin, VSF_GPIO_OPEN_DRAIN | VSF_GPIO_PULL_UP);
    vsf_gpio_config_pin(gpio_i2c_ptr->port, 1 << gpio_i2c_ptr->sda_pin, VSF_GPIO_OPEN_DRAIN | VSF_GPIO_PULL_UP);
