...
enum {
    ...
    I2C_GPIO_CMD_SCL_FALLING_EDGE               = (0x01ul << 7),
    I2C_GPIO_CMD_SCL_RISING_EDGE                = (0x00ul << 8),
    I2C_GPIO_CMD_SCL_EDGE                       = (0x01ul << 9),
};
...
static void __i2c_gpio_callback(VSF_I2C_GPIO_USE_CALL_BACK_TIMER *on_timer)
{
    ...
    if (i2c_ptr->irq_mask & I2C_IRQ_MASK_MASTER_NACK_DETECT) {
        if (i2c_ptr->cmd & I2C_CMD_STOP) {
            ...
            __vsf_i2c_master_irq_handler_base(i2c_ptr,
                                              i2c_ptr->irq_mask & i2c_ptr->enabled_irq_mask, 0);
            return;
        }
    }
    if (i2c_ptr->cmd & I2C_CMD_START) {
        ...
        goto label_address;
    } else if (i2c_ptr->cmd & I2C_CMD_RESTAR) {
        ...
        i2c_ptr->i2c_gpio_cmd |= I2C_CMD_RESTAR_1;
        goto label_return;
    } else if (i2c_ptr->i2c_gpio_cmd & I2C_CMD_RESTAR_1) {
        vsf_gpio_write(i2c_ptr->gpio_info.gpio, 0,
                       i2c_ptr->gpio_info.sda_pin_mask);
        vsf_gpio_write(i2c_ptr->gpio_info.gpio, 0,
                       i2c_ptr->gpio_info.scl_pin_mask);
        i2c_ptr->irq_mask |= I2C_IRQ_MASK_MASTER_STARTED;
        goto label_address;
    } else if (i2c_ptr->i2c_gpio_cmd & I2C_GPIO_CMD_SCL_FALLING_EDGE) {
        vsf_gpio_write(i2c_ptr->gpio_info.gpio, 0,
                       i2c_ptr->gpio_info.scl_pin_mask);
    ...
    label_address:
        ...
        vsf_gpio_write(i2c_ptr->gpio_info.gpio,
                       i2c_ptr->gpio_info.scl_pin_mask,
                       i2c_ptr->gpio_info.scl_pin_mask);
        if (    (vsf_gpio_read(i2c_ptr->gpio_info.gpio))
            &   (i2c_ptr->gpio_info.sda_pin_mask)) {
...
#   include "hal/driver/common/i2c/__i2c_common.inc"
#endif
