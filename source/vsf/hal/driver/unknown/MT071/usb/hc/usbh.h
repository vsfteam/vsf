...
#ifndef __HAL_DRIVER_MT071_USBH_H__
...
#define mt071_usbh_ep_number            8
#define mt071_usbh_ep_is_dma            false
...
extern vsf_err_t mt071_usbh_init(mt071_usb_t *hc, usb_hc_ip_cfg_t *cfg);
