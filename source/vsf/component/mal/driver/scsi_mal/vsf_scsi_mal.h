...
#if     defined(VSF_SCSI_MAL_IMPLEMENT)
#   undef VSF_SCSI_MAL_IMPLEMENT
#   define __PLOOC_CLASS_IMPLEMENT
#elif   defined(VSF_SCSI_MAL_INHERIT)
#   undef VSF_SCSI_MAL_INHERIT
...
declare_simple_class(vk_scsi_mal_t)
