...
const vsf_input_item_info_t vsf_xb360_gamepad_item_info[GAMEPAD_ID_NUM] = {
...
void vsf_xb360_on_new_dev(vsf_input_xb360_t *dev)
{
...
void vsf_xb360_on_free_dev(vsf_input_xb360_t *dev)
{
...
void vsf_xb360_on_report_input(vsf_gamepad_evt_t *gamepad_evt)
{
...
void vsf_xb360_new_dev(vsf_input_xb360_t *dev)
{
...
void vsf_xb360_free_dev(vsf_input_xb360_t *dev)
{
#ifndef WEAK_VSF_XB360_ON_FREE_DEV
...
void vsf_xb360_process_input(vsf_input_xb360_t *dev, vsf_usb_xb360_gamepad_in_report_t *data)
{
    union {
        struct {
    ...
    parser.gamepad.parser.info      = (vsf_input_item_info_t *)vsf_xb360_gamepad_item_info;
    parser.gamepad.parser.num       = dimof(vsf_xb360_gamepad_item_info);
    do {
