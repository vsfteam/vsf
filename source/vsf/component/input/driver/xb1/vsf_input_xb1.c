...
WEAK(vk_xb1_on_new_dev)
void vk_xb1_on_new_dev(vk_input_xb1_t *dev)
{
#   ifndef WEAK_VSF_INPUT_ON_NEW_DEV
    vk_input_on_new_dev(VSF_INPUT_TYPE_XB1, dev);
#   else
...
WEAK(vk_xb1_on_free_dev)
void vk_xb1_on_free_dev(vk_input_xb1_t *dev)
{
#   ifndef WEAK_VSF_INPUT_ON_FREE_DEV
    vk_input_on_free_dev(VSF_INPUT_TYPE_XB1, dev);
#   else
...
WEAK(vk_xb1_on_report_input)
void vk_xb1_on_report_input(vk_gamepad_evt_t *gamepad_evt)
{
...
#ifndef WEAK_VSF_XB1_ON_REPORT_INPUT
            vk_xb1_on_report_input(&parser.gamepad.evt);
#else
