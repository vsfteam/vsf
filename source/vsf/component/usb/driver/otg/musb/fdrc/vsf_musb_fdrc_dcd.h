...
extern void vsf_musb_fdrc_usbd_reset(vsf_musb_fdrc_dcd_t *usbd);
...
extern uint_fast16_t vsf_musb_fdrc_usbd_ep_get_data_size(vsf_musb_fdrc_dcd_t *usbd, uint_fast8_t ep);
