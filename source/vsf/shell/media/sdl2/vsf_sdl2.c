...
int __vsf_sdl2_get_desktop_display_mode(int display_index, SDL_DisplayMode *mode)
{
...
SDL_Surface * __vsf_sdl2_create_rgb_sruface_with_format(uint32_t flags, int w, int h, int depth, uint32_t format)
{
...
void __vsf_sdl2_free_surface(SDL_Surface *surface)
{
...
SDL_Texture * __vsf_sdl2_create_texture_from_surface(SDL_Renderer *renderer, SDL_Surface *surface)
{
