...
#   define vsf_msg_queue_t              vsf_list_queue_t
#   define vsf_eda_msg_queue_init(__queue, __max)                               \
                vsf_eda_list_queue_init((__queue), (__max))
#   define vsf_eda_msg_queue_send(__queue, __node, __timeout)                   \
                vsf_eda_queue_send((vsf_queue_t *)(__queue), (__node), (__timeout))
#   define vsf_eda_msg_queue_send_get_reason(__queue, __evt, __node)            \
                vsf_eda_queue_send_get_reason((vsf_queue_t *)(__queue), (__evt), (__node))
#   define vsf_eda_msg_queue_recv(__queue, __node, __timeout)                   \
                vsf_eda_queue_recv((vsf_queue_t *)(__queue), (void **)(__node), (__timeout))
#   define vsf_eda_msg_queue_recv_get_reason(__queue, __evt, __node)            \
                vsf_eda_queue_recv_get_reason((vsf_queue_t *)(__queue), (__evt), (void **)(__node))
...
declare_simple_class(vsf_list_queue_t)

def_simple_class(vsf_list_queue_t) {
    public_member(
...
#if __VSF_KERNEL_CFG_SUPPORT_LIST_QUEUE == ENABLED
extern vsf_err_t vsf_eda_list_queue_init(vsf_list_queue_t *pthis, uint_fast16_t max);
#endif

#endif
#endif      // __VSF_QUEUE_H__
