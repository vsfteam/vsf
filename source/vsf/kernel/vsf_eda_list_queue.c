...
static bool __vsf_eda_list_queue_enqueue(vsf_eda_queue_t *pthis, void *node)
{
...
static bool __vsf_eda_list_queue_dequeue(vsf_eda_queue_t *pthis, void **node)
{
...
{
    pthis->use_as__vsf_eda_queue_t.op.enqueue = __vsf_eda_list_queue_enqueue;
    pthis->use_as__vsf_eda_queue_t.op.dequeue = __vsf_eda_list_queue_dequeue;
