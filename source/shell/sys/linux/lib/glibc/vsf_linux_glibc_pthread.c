...
__VSF_VPLT_DECORATOR__ vsf_linux_pthread_vplt_t vsf_linux_pthread_vplt = {
    .info.entry_num = (sizeof(vsf_linux_pthread_vplt_t) - sizeof(vsf_vplt_info_t)) / sizeof(void *),

    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_key_create),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_key_delete),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_setspecific),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_getspecific),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutex_init),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutex_destroy),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutex_lock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutex_trylock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutex_unlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutexattr_init),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutexattr_destroy),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutexattr_setpshared),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutexattr_getpshared),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutexattr_settype),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_mutexattr_gettype),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_cond_init),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_cond_destroy),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_cond_signal),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_cond_broadcast),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_cond_wait),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_cond_timedwait),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_condattr_init),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_condattr_destroy),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_condattr_setpshared),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_condattr_getpshared),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_condattr_getclock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_condattr_setclock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_init),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_destroy),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_rdlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_tryrdlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_timedrdlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_wrlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_trywrlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_timedwrlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_rwlock_unlock),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_atfork),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_self),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_equal),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_create),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_join),
    ...
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getstack),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setstackaddr),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getstackaddr),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setstacksize),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getstacksize),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setguardsize),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getguardsize),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setdetachstate),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getdetachstate),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setinheritsched),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getinheritsched),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setschedparam),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_getschedparam),
    VSF_LINUX_APPLET_PTHREAD_FUNC(pthread_attr_setschedpolicy),
