...
__VSF_VPLT_DECORATOR__ vsf_linux_libc_stdio_vplt_t vsf_linux_libc_stdio_vplt = {
    .info.entry_num = (sizeof(vsf_linux_libc_stdio_vplt_t) - sizeof(vsf_vplt_info_t)) / sizeof(void *),

    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(__vsf_linux_stdin),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(__vsf_linux_stdout),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(__vsf_linux_stderr),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(perror),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(putchar),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(getchar),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fgetc),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fputc),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(getc),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(putc),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(ungetc),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(puts),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fputs),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fgets),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(scanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vfscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(printf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vfprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fopen),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fdopen),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(freopen),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(fclose),
    ...
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(popen),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(pclose),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(rename),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(renameat),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(ferror),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(clearerr),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(feof),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(sprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vsprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(snprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vsnprintf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vsscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(vsnscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(snscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(sscanf),
    VSF_LINUX_APPLET_LIBC_STDIO_FUNC(remove),
};
#endif
