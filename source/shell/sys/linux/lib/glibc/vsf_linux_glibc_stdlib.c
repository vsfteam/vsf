...
__VSF_VPLT_DECORATOR__ vsf_linux_libc_stdlib_vplt_t vsf_linux_libc_stdlib_vplt = {
    .info.entry_num = (sizeof(vsf_linux_libc_stdlib_vplt_t) - sizeof(vsf_vplt_info_t)) / sizeof(void *),

    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(malloc),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(realloc),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(free),
    ...
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(putenv),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(getenv),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(setenv),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(unsetenv),
#endif
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mktemps),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mktemp),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mkstemp),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mkostemp),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mkstemps),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mkostemps),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(mkdtemp),

    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(div),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(ldiv),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(lldiv),

    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(itoa),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(atoi),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(atol),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(atoll),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(atof),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(strtol),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(strtoul),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(strtoll),
    ...
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(rand),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(srand),

    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(abort),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(system),

    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(exit),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(atexit),

    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(abs),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(labs),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(llabs),
    VSF_LINUX_APPLET_LIBC_STDLIB_FUNC(imaxabs),
};
#endif
