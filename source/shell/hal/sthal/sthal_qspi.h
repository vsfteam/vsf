...
#ifdef VSF_SPI_CTRL_ADDRESS_BITS_8
#   define QSPI_ADDRESS_8_BITS VSF_SPI_CTRL_ADDRESS_BITS_8
#else
#   define QSPI_ADDRESS_8_BITS 0
#endif

#ifdef VSF_SPI_CTRL_ADDRESS_BITS_16
#   define QSPI_ADDRESS_16_BITS VSF_SPI_CTRL_ADDRESS_BITS_16
#else
#   define QSPI_ADDRESS_16_BITS 0
#endif

#ifdef VSF_SPI_CTRL_ADDRESS_BITS_24
#   define QSPI_ADDRESS_24_BITS VSF_SPI_CTRL_ADDRESS_BITS_24
#else
#   define QSPI_ADDRESS_24_BITS 0
#endif

#ifdef VSF_SPI_CTRL_ADDRESS_BITS_32
#   define QSPI_ADDRESS_32_BITS VSF_SPI_CTRL_ADDRESS_BITS_32
#else
...
#   define QSPI_DATA_NONE VSF_SPI_CTRL_DATA_PHASE_SINGLE
#else
#   define QSPI_DATA_NONE 0
#endif

#ifdef VSF_SPI_CTRL_DATA_PHASE_SINGLE
#   define QSPI_DATA_1_LINE VSF_SPI_CTRL_DATA_PHASE_SINGLE
#else
#   define QSPI_DATA_1_LINE 0
#endif

#ifdef VSF_SPI_CTRL_DATA_PHASE_DUAL
#   define QSPI_DATA_2_LINES VSF_SPI_CTRL_DATA_PHASE_DUAL
#else
#   define QSPI_DATA_2_LINES 0
#endif

#ifdef VSF_SPI_CTRL_DATA_PHASE_QUAD
#   define QSPI_DATA_4_LINES VSF_SPI_CTRL_DATA_PHASE_QUAD
#else
