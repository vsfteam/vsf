...
struct gpio_reg_t {
    volatile uint32_t UNUSED_OFFSET0;
    volatile uint32_t UNUSED_OFFSET4;
    volatile uint32_t DOUT;
    volatile uint32_t UNUSED_OFFSETC;
    volatile uint32_t PIN;
    volatile uint32_t UNUSED_OFFSET14;
    volatile uint32_t UNUSED_OFFSET18;
    volatile uint32_t UNUSED_OFFSET1C;
    volatile uint32_t UNUSED_OFFSET20;
    volatile uint32_t UNUSED_OFFSET24;
    volatile uint32_t UNUSED_OFFSET28;
    volatile uint32_t UNUSED_OFFSET2C;
    volatile uint32_t UNUSED_OFFSET30;
};
...
enum io_pin_no_t {
    ...
    MREPEAT(PIO_PORTB_PIN_NUM, __IO_PINB_NUM, 16)
#endif
#if defined(PIO_PORTC)
    MREPEAT(PIO_PORTC_PIN_NUM, __IO_PINC_NUM, 32)
#endif
#if defined(PIO_PORTD)
    MREPEAT(PIO_PORTD_PIN_NUM, __IO_PIND_NUM, 48)
#endif
};
//! @}
