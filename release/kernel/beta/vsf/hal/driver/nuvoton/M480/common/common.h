...
#ifndef VSF_HAL_CFG_ATOM_ACCESS
/*! \note   By default, the driver tries to make all APIs interrupt-safe, in the 
 *!         case when you want to disable it, please use following macro to 
 *!         disable it:
 *!         
 *!         #define VSF_HAL_CFG_ATOM_ACCESS()           \
 *!             code_region(&DEFAULT_CODE_REGION_NONE)
 *!         
 *!         NOTE: This macro should be defined in app_cfg.h or vsf_cfg.h
 */
#   define VSF_HAL_CFG_ATOM_ACCESS()    code_region(&DEFAULT_CODE_REGION_ATOM_CODE)
#endif
