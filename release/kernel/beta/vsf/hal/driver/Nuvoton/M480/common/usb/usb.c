...
REPEAT_MACRO(USB_HC_COUNT, __USB_HC_IP_BODY, m480_ohci)
#endif

#if USB_DC_HS_COUNT > 0
REPEAT_MACRO(USB_DC_HS_COUNT, __USB_DC_BODY, m480_usbd_hs)
#endif

#if USB_DC_FS_COUNT > 0
REPEAT_MACRO(USB_DC_FS_COUNT, __USB_DC_BODY, m480_usbd_fs)
#endif
