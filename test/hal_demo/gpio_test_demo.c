...
#   define APP_GPIO_DEMO_CFG_INPUT_FEATURE              (VSF_IO_PULL_UP)
#endif

#ifndef APP_GPIO_DEMO_CFG_OUTPUT_FEATURE
#   define APP_GPIO_DEMO_CFG_OUTPUT_FEATURE             (VSF_IO_PULL_UP)
#endif

#ifndef APP_GPIO_DEMO_CFG_OUTPUT_TOGGLE_FEATURE
#   define APP_GPIO_DEMO_CFG_OUTPUT_TOGGLE_FEATURE      (VSF_IO_PULL_UP)
#endif
