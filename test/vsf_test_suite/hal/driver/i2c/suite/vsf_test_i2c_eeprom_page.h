...
#endif
#ifndef VSF_TEST_I2C_EEPROM_PAGE_PATTERN_BYTE
#   define VSF_TEST_I2C_EEPROM_PAGE_PATTERN_BYTE              0xB0
#endif

#ifndef VSF_TEST_I2C_EEPROM_PAGE_PRIO
#   define VSF_TEST_I2C_EEPROM_PAGE_PRIO            vsf_arch_prio_1
#endif

#ifndef VSF_TEST_I2C_EEPROM_PAGE_READ_BUF_SIZE
#   define VSF_TEST_I2C_EEPROM_PAGE_READ_BUF_SIZE        16
#endif
...
#ifndef VSF_TEST_I2C_EEPROM_PAGE_CMD_2
#   define VSF_TEST_I2C_EEPROM_PAGE_CMD_2                          (VSF_I2C_CMD_RESTART|VSF_I2C_CMD_STOP|VSF_I2C_CMD_READ|VSF_I2C_CMD_7_BITS)
#endif

#ifndef VSF_TEST_I2C_EEPROM_PAGE_CMD_1
#   define VSF_TEST_I2C_EEPROM_PAGE_CMD_1                          (VSF_I2C_CMD_START|VSF_I2C_CMD_WRITE|VSF_I2C_CMD_NO_STOP|VSF_I2C_CMD_7_BITS)
#endif

#ifndef VSF_TEST_I2C_EEPROM_PAGE_WRITE_CMD
#   define VSF_TEST_I2C_EEPROM_PAGE_WRITE_CMD                      (VSF_I2C_CMD_START|VSF_I2C_CMD_STOP|VSF_I2C_CMD_WRITE|VSF_I2C_CMD_7_BITS)
#endif
...
typedef struct {
    ...
    uint8_t  mem_addr;
    uint8_t  data_len;
} vsf_test_i2c_eeprom_page_params_t;

struct vsf_test_i2c_eeprom_page_s;
extern const struct vsf_test_i2c_eeprom_page_s vsf_test_i2c_eeprom_page;
...
#endif /* __TEST_I2C_EEPROM_PAGE_H__ */
/* EOF */
