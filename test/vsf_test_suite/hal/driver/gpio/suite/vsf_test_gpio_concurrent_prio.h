...
#ifndef __TEST_GPIO_CONCURRENT_PRIO_H__
#define __TEST_GPIO_CONCURRENT_PRIO_H__
...
} vsf_test_gpio_concurrent_prio_params_t;

struct vsf_test_gpio_concurrent_prio_s;
extern const struct vsf_test_gpio_concurrent_prio_s vsf_test_gpio_concurrent_prio;
...
#endif /* __TEST_GPIO_CONCURRENT_PRIO_H__ */
/* EOF */
