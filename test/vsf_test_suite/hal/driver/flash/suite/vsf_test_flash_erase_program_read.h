...
#ifndef __TEST_FLASH_ERASE_PROGRAM_READ_H__
...
#endif
#ifndef VSF_TEST_FLASH_ERASE_PROGRAM_READ_PATTERN_BYTE
#   define VSF_TEST_FLASH_ERASE_PROGRAM_READ_PATTERN_BYTE     0xA5
#endif

#ifndef VSF_TEST_FLASH_ERASE_PROGRAM_READ_PRIO
#   define VSF_TEST_FLASH_ERASE_PROGRAM_READ_PRIO   vsf_arch_prio_1
#endif
...
/*============================ PROTOTYPES ====================================*/
#define VSF_TEST_FLASH_ERASE_EXPECTED_VALUE           0xFF
...
typedef struct {
    ...
    uint32_t offset;
    uint32_t size;
} vsf_test_flash_erase_program_read_params_t;

struct vsf_test_flash_erase_program_read_s;
extern const struct vsf_test_flash_erase_program_read_s vsf_test_flash_erase_program_read;
...
#endif /* __TEST_FLASH_ERASE_PROGRAM_READ_H__ */
/* EOF */
