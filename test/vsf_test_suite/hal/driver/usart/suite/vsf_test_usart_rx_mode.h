...
#ifndef __TEST_USART_RX_MODE_H__
#define __TEST_USART_RX_MODE_H__
...
#ifndef VSF_TEST_USART_RX_MODE_BUSY_WAIT_MS
#   define VSF_TEST_USART_RX_MODE_BUSY_WAIT_MS                10
#endif
...
typedef struct {
    ...
    bool             expect_pass;
} vsf_test_usart_rx_mode_params_t;

struct vsf_test_usart_rx_mode_s;
extern const struct vsf_test_usart_rx_mode_s vsf_test_usart_rx_mode;
...
#endif /* __TEST_USART_RX_MODE_H__ */
/* EOF */
