...
#ifndef __TEST_USART_RX_BAUD_H__
#define __TEST_USART_RX_BAUD_H__
...
#ifndef VSF_TEST_USART_RX_BAUD_BUSY_WAIT_MS
#   define VSF_TEST_USART_RX_BAUD_BUSY_WAIT_MS                10
#endif
...
typedef struct {
    ...
    uint32_t baudrate;
    bool     expect_pass;
} vsf_test_usart_rx_baud_params_t;

struct vsf_test_usart_rx_baud_s;
extern const struct vsf_test_usart_rx_baud_s vsf_test_usart_rx_baud;
...
#endif /* __TEST_USART_RX_BAUD_H__ */
/* EOF */
