...
def decode(adapter: LogicAnalyzer, channels: dict, capture_path: Path,
    ...
    """Decode and verify frame errors are present in the captured UART stream.

    NOTE: This decoder relies on dsview-cli UART decoder reporting frame-error
    ...
    for c in cases:
        ...
        print(f"[PASS] CASE {c.idx}  rx_frame_error  (TODO: verify frame error flags)")
