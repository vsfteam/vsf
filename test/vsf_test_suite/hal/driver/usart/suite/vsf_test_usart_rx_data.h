...
#ifndef VSF_TEST_USART_RX_DATA_BUSY_WAIT_MS
#   define VSF_TEST_USART_RX_DATA_BUSY_WAIT_MS                10
#endif
...
/*============================ PROTOTYPES ====================================*/
#define VSF_TEST_USART_RX_DATA_MIN_TIMEOUT_MS         5000
#define VSF_TEST_USART_RX_DATA_STACK_BUF_SIZE         32
...
typedef struct {
    ...
    bool     expect_pass;
} vsf_test_usart_rx_data_params_t;

struct vsf_test_usart_rx_data_s;
extern const struct vsf_test_usart_rx_data_s vsf_test_usart_rx_data;
