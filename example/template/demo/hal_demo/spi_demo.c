...
static const hal_option_t __mode_options[] = {
    ...
    HAL_DEMO_OPTION(VSF_SPI_CLOCK_MODE_MASK, VSF_SPI_MODE_0),
    HAL_DEMO_OPTION(VSF_SPI_CLOCK_MODE_MASK, VSF_SPI_MODE_1),
    HAL_DEMO_OPTION(VSF_SPI_CLOCK_MODE_MASK, VSF_SPI_MODE_2),
    HAL_DEMO_OPTION(VSF_SPI_CLOCK_MODE_MASK, VSF_SPI_MODE_3),
