...
static const char *__vsfvm_errcode_str[] = {
    VSF_STR(VSFVM_ERRCODE_NONE),

    // common error
    VSF_STR(VSFVM_BUG),
    VSF_STR(VSFVM_BYTECODE_TOOLONG),
    VSF_STR(VSFVM_NOT_ENOUGH_RESOURCES),
    VSF_STR(VSFVM_FATAL_ERROR),
    VSF_STR(VSFVM_NOT_SUPPORT),

    // lexer error
    VSF_STR(VSFVM_LEXER_NOT_SUPPORT),
    VSF_STR(VSFVM_LEXER_INVALID_OP),
    VSF_STR(VSFVM_LEXER_INVALID_CHAR),
    VSF_STR(VSFVM_LEXER_INVALID_STRING),
    VSF_STR(VSFVM_LEXER_INVALID_ESCAPE),
    VSF_STR(VSFVM_LEXER_SYMBOL_TOO_LONG),

    // parser error
    VSF_STR(VSFVM_PARSER_UNEXPECTED_TOKEN),
    VSF_STR(VSFVM_PARSER_ALREADY_DEFINED),
    VSF_STR(VSFVM_PARSER_INVALID_CLOSURE),
    VSF_STR(VSFVM_PARSER_INVALID_EXPR),
    VSF_STR(VSFVM_PARSER_UNINITED_CONST),
    VSF_STR(VSFVM_PARSER_INVALID_CONST),
    VSF_STR(VSFVM_PARSER_DIV0),
    VSF_STR(VSFVM_PARSER_EXPECT_FUNC_PARAM),
    VSF_STR(VSFVM_PARSER_TOO_MANY_FUNC_PARAM),
    VSF_STR(VSFVM_PARSER_MEMFUNC_NOT_FOUND),

    // compiler error
    VSF_STR(VSFVM_COMPILER_INVALID_MODULE),
    VSF_STR(VSFVM_COMPILER_INVALID_FUNC),
    VSF_STR(VSFVM_COMPILER_INVALID_FUNC_PARAM),
    VSF_STR(VSFVM_COMPILER_FAIL_USRLIB),
};
